...
export default function Admin() {
      ...
      <div className="min-h-screen bg-brand-beige flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="space-y-2">
            <h1 className="text-3xl font-serif text-brand-secondary">
              Admin Access
            </h1>
  ...
  const handleSeed = async () => {
    try {
      ...
      const whyDefaults = [
        {
          imageUrl:
            "https://images.unsplash.com/photo-1542601906990-b4d3fb77db21?auto=format&fit=crop&q=80&w=600",
          title: "Sustainable Practices",
          description:
            "From carbon-neutral shipping to 100% recycled paper stocks, we prioritize the planet as much as the prose.",
          order: 0,
        },
        {
          imageUrl:
          ...
          description:
            "We operate like a small boutique press with the resources of a global leader, giving you space to innovate.",
          order: 1,
        },
        {
          imageUrl:
          ...
          description:
            "Enjoy a generous annual book stipend, silent reading hours, and frequent author-led workshops.",
          order: 2,
        },
      ];
      ...
      const jobDefaults = [
        {
          ...
          location: "Accra",
          type: "Full-Time",
          desc: "Lead our fiction department in discovering new voices from across West Africa.",
          imageUrl:
            "https://images.unsplash.com/photo-1554446422-d05db23719d2?auto=format&fit=crop&q=80&w=600",
        },
        {
          category: "Design",
          ...
          location: "Accra",
          type: "Full-Time",
          desc: "Crafting visual identities for our upcoming high-end literary fiction series.",
          imageUrl:
  ...
  const handleUpdateSettings = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await setDoc(doc(db, "settings", "global"), submissionData, {
        merge: true,
      });
      ...
      setStatus({
        type: "error",
        msg: `Update failed: ${err?.message || "Check firestore permissions"}`,
      });
    } finally {
      setIsSaving(false);
    }
  ...
  const handleSaveItem = async (coll: string, data: any, id?: string) => {
    ...
    try {
      ...
      setStatus({
        type: "error",
        msg: `Save failed: ${err?.message || "Check connection"}`,
      });
    } finally {
      setIsSaving(false);
    }
      ...
      <div className="bg-brand-secondary text-white p-6 shadow-xl sticky top-24 lg:top-32 z-40 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-6">
          <div className="hidden md:block text-right">
            <p className="text-xs font-bold font-sans uppercase tracking-widest text-brand-primary">
              Control Panel
            </p>
        ...
        <main className="lg:col-span-9 space-y-8">
          {status && (
            ...
            >
              ...
              <button className="ml-auto" onClick={() => setStatus(null)}>
                <X size={16} />
              </button>
            </motion.div>
          )}
          ...
          <div className="bg-white rounded-[40px] shadow-xl p-8 lg:p-12 min-h-[600px] border border-gray-100">
                  ...
                  >
                    <div className="space-y-4 md:col-span-2">
                      ...
                      <div className="pt-8 mt-8 border-t border-gray-100">
                        <h3 className="text-sm font-bold uppercase tracking-widest text-brand-primary mb-6">
                            ...
                            {formData.aboutHeritageImageUrl && (
                              <div className="relative group/img">
                                <div className="aspect-video w-full rounded-xl overflow-hidden border">
                                  <img
                                    src={formData.aboutHeritageImageUrl}
                                    alt="Heritage"
                          ...
                          <div className="space-y-4">
                            ...
                            {formData.aboutStoryImageUrl && (
                              <div className="relative group/img">
                                <div className="aspect-video w-full rounded-xl overflow-hidden border">
                                  <img
                                    src={formData.aboutStoryImageUrl}
                                    alt="Our Story"
                                    className="w-full h-full object-cover"
                                  />
                                </div>
                          ...
                          <div className="space-y-4">
                            ...
                            {formData.careersHeroImageUrl && (
                              <div className="relative group/img">
                                <div className="aspect-video w-full rounded-xl overflow-hidden border">
                                  <img
                                    src={formData.careersHeroImageUrl}
                                    alt="Careers"
                                    className="w-full h-full object-cover"
                                  />
                                </div>
                          ...
                          <div className="space-y-4">
                            ...
                            {formData.clientsHeroImageUrl && (
                              <div className="relative group/img">
                                <div className="aspect-video w-full rounded-xl overflow-hidden border">
                                  <img
                                    src={formData.clientsHeroImageUrl}
                                    alt="Clients"
                                    className="w-full h-full object-cover"
                                  />
                                </div>
                          ...
                          <div className="space-y-4">
                            ...
                            {formData.printHeroImageUrl && (
                              <div className="relative group/img">
                                <div className="aspect-video w-full rounded-xl overflow-hidden border">
                                  <img
                                    src={formData.printHeroImageUrl}
                                    alt="Print Hero"
                                    className="w-full h-full object-cover"
                                  />
                                </div>
                          ...
                          <div className="space-y-4">
                            <ImageUpload
                              onUploadComplete={(url) =>
                                setFormData((prev) => ({
                                  ...prev,
                                  printOffsetBgImageUrl: url,
                                }))
                              }
                              folder="site"
                              label="Print Page: Offset Printing Section Background Image"
                            />
                            {formData.printOffsetBgImageUrl && (
                              <div className="relative group/img">
                                <div className="aspect-video w-full rounded-xl overflow-hidden border">
                                  <img
                                    src={formData.printOffsetBgImageUrl}
                                    alt="Offset printing background"
                                    className="w-full h-full object-cover"
                                  />
                                </div>
                                <button
                          ...
                          <div className="space-y-4">
                            <ImageUpload
                              onUploadComplete={(url) =>
                                setFormData((prev) => ({
                                  ...prev,
                                  printDigitalBgImageUrl: url,
                                }))
                              }
                              folder="site"
                              label="Print Page: Digital Printing Section Background Image"
                            />
                            {formData.printDigitalBgImageUrl && (
                              <div className="relative group/img">
                                <div className="aspect-video w-full rounded-xl overflow-hidden border">
                                  <img
                                    src={formData.printDigitalBgImageUrl}
                          ...
                          <div className="space-y-4">
                            <ImageUpload
                              onUploadComplete={(url) =>
                                setFormData((prev) => ({
                                  ...prev,
                                  printBrandingBgImageUrl: url,
                                }))
                              }
                              folder="site"
                              label="Print Page: Branding Section Background Image"
                            />
                            {formData.printBrandingBgImageUrl && (
                              <div className="relative group/img">
                                <div className="aspect-video w-full rounded-xl overflow-hidden border">
                                  <img
                                    src={formData.printBrandingBgImageUrl}
                                    alt="Branding section background"
                                    className="w-full h-full object-cover"
                                  />
                                </div>
                                <button
                          ...
                          <div className="space-y-4">
                            <ImageUpload
                              onUploadComplete={(url) =>
                                setFormData((prev) => ({
                                  ...prev,
                                  printSouvenirsBgImageUrl: url,
                                }))
                              }
                              folder="site"
                              label="Print Page: Souvenirs Section Background Image"
                            />
                            {formData.printSouvenirsBgImageUrl && (
                              <div className="relative group/img">
                                <div className="aspect-video w-full rounded-xl overflow-hidden border">
                                  <img
                                    src={formData.printSouvenirsBgImageUrl}
                                    alt="Souvenirs section background"
                                    className="w-full h-full object-cover"
                                  />
                                </div>
                                <button
                                  ...
                                  onClick={() =>
                                    setFormData((prev) => ({
                                      ...prev,
                                      printSouvenirsBgImageUrl: "",
                                    }))
                                  }
                                  className="absolute top-2 right-2 p-2 bg-[#ff5722] text-white rounded-full opacity-0 group-hover/img:opacity-100 transition-opacity shadow-lg"
                                >
                                  <X size={12} />
                                </button>
                              </div>
                          ...
                          <div className="space-y-4">
                            ...
                            {formData.printAboutImageUrl && (
                              <div className="relative group/img">
                                <div className="aspect-video w-full rounded-xl overflow-hidden border">
                                  <img
                                    src={formData.printAboutImageUrl}
                                    alt="Print About"
                                    className="w-full h-full object-cover"
                                  />
                                </div>
                          ...
                          <div className="space-y-4">
                            <ImageUpload
                              onUploadComplete={(url) =>
                                setFormData((prev) => ({
                                  ...prev,
                                  careersWhyRichkissImageUrl: url,
                                }))
                              }
                              folder="site"
                            ...
                            {formData.careersWhyRichkissImageUrl && (
                              <div className="relative group/img">
                                <div className="aspect-video w-full rounded-xl overflow-hidden border">
                                  <img
                                    src={formData.careersWhyRichkissImageUrl}
                                    alt="Why Richkiss"
                                    className="w-full h-full object-cover"
                                  />
                                </div>
                      ...
                      <div className="pt-4 mt-4 border-t border-gray-100 space-y-4">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                          {formData.heroImages?.map(
                            (img: string, i: number) => (
                              <div
                                key={i}
                                className="relative aspect-[3/4] bg-gray-200 rounded-2xl overflow-hidden border border-gray-100 shadow-sm group"
                              >
                                <img
                                  src={img}
                                  alt={`Hero ${i + 1}`}
                    ...
                    <div className="flex space-x-4 md:col-span-2 pt-4">
                      ...
                      <button
                        ...
                        disabled={isSaving}
                        className="px-8 py-4 border border-gray-200 rounded-full font-bold hover:bg-gray-50 transition-colors"
                      >
                        Cancel
                      </button>
                    </div>
                          ...
                          settings.heroImages.length > 0 ? (
                            settings.heroImages.map(
                              (img: string, i: number) => (
                                <div
                                  key={i}
                                  className="aspect-[3/4] bg-brand-beige rounded-2xl overflow-hidden border border-gray-100 shadow-sm"
                                >
                                  <img
                                    src={img}
                                    alt={`Slide ${i + 1}`}
                      ...
                      <div className="space-y-4 md:col-span-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                          <div className="space-y-2">
                            ...
                            <div className="aspect-video bg-brand-beige rounded-2xl overflow-hidden border border-gray-100">
                              {settings.aboutHeritageImageUrl ? (
                                <img
                                  src={settings.aboutHeritageImageUrl}
                                  alt="About Heritage"
                                  className="w-full h-full object-cover"
                                />
                              ) : (
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="aspect-video bg-brand-beige rounded-2xl overflow-hidden border border-gray-100">
                              {settings.printOffsetBgImageUrl ? (
                                <img
                                  src={settings.printOffsetBgImageUrl}
                                  alt="Print Offset Background"
                                  className="w-full h-full object-cover"
                                />
                              ) : (
                                <div className="w-full h-full flex items-center justify-center text-brand-muted opacity-30">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="aspect-video bg-brand-beige rounded-2xl overflow-hidden border border-gray-100">
                              {settings.printDigitalBgImageUrl ? (
                                <img
                                  src={settings.printDigitalBgImageUrl}
                                  alt="Print Digital Background"
                                  className="w-full h-full object-cover"
                                />
                              ) : (
                                <div className="w-full h-full flex items-center justify-center text-brand-muted opacity-30">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="aspect-video bg-brand-beige rounded-2xl overflow-hidden border border-gray-100">
                              {settings.printBrandingBgImageUrl ? (
                                <img
                                  src={settings.printBrandingBgImageUrl}
                                  alt="Print Branding Background"
                                  className="w-full h-full object-cover"
                                />
                              ) : (
                                <div className="w-full h-full flex items-center justify-center text-brand-muted opacity-30">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="aspect-video bg-brand-beige rounded-2xl overflow-hidden border border-gray-100">
                              {settings.printSouvenirsBgImageUrl ? (
                                <img
                                  src={settings.printSouvenirsBgImageUrl}
                                  alt="Print Souvenirs Background"
                                  className="w-full h-full object-cover"
                                />
                              ) : (
                                <div className="w-full h-full flex items-center justify-center text-brand-muted opacity-30">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="aspect-video bg-brand-beige rounded-2xl overflow-hidden border border-gray-100">
                              {settings.careersHeroImageUrl ? (
                                <img
                                  src={settings.careersHeroImageUrl}
                                  alt="Careers Hero"
                                  className="w-full h-full object-cover"
                                />
                              ) : (
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="aspect-video bg-brand-beige rounded-2xl overflow-hidden border border-gray-100">
                              {settings.careersWhyRichkissImageUrl ? (
                                <img
                                  src={settings.careersWhyRichkissImageUrl}
                                  alt="Careers Why Us"
                                  className="w-full h-full object-cover"
                                />
                              ) : (
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {categories.map((cat: any) => (
                    <div
                      key={cat.id}
                      className="p-6 bg-brand-beige/30 rounded-3xl border border-gray-100 flex items-center justify-between group"
                    >
                      <div className="flex items-center space-x-4">
                ...
                <AnimatePresence>
                  {(isEditing === "new-category" ||
                    categories.some((c) => c.id === isEditing)) && (
                    <motion.div
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      exit={{ opacity: 0 }}
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="flex space-x-4">
                          ...
                          <button
                            onClick={() => setIsEditing(null)}
                            className="px-8 py-4 border border-gray-200 rounded-full font-bold"
                          >
                            Cancel
                          </button>
                        </div>
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
                  {books.map((book: any) => (
                    <div
                      key={book.id}
                      className="p-4 bg-brand-beige/30 rounded-3xl border border-gray-100 space-y-4 group"
                    >
                      <div className="relative aspect-[3/4] rounded-2xl overflow-hidden bg-gray-200">
                        ...
                        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center space-x-2">
                          <button
                            ...
                            className="p-3 bg-white rounded-xl text-brand-secondary hover:text-brand-primary transition-all scale-90 group-hover:scale-100"
                          >
                            <Edit2 size={18} />
                          </button>
                          <button
                            onClick={() => handleDelete("books", book.id)}
                            className="p-3 bg-white rounded-xl text-red-500 hover:bg-red-500 hover:text-white transition-all scale-90 group-hover:scale-100"
                          >
                            <Trash2 size={18} />
                          </button>
                        </div>
                      ...
                      <div className="space-y-1">
                        <h3 className="font-bold font-serif text-brand-secondary line-clamp-1">
                          {book.title}
                        </h3>
                        ...
                        <div className="flex justify-between items-center pt-2">
                          <span className="text-xs font-bold px-2 py-1 bg-brand-primary/10 text-brand-primary rounded-full uppercase">
                            {book.categorySlug}
                          </span>
                      ...
                      >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div className="md:col-span-2 flex space-x-6 pt-2">
                            <label className="flex items-center space-x-3 cursor-pointer group/check">
                              ...
                              />
                              <span className="text-xs font-bold uppercase tracking-widest text-brand-secondary group-hover/check:text-brand-primary transition-colors">
                                New Arrival
                              </span>
                            </label>
                            <label className="flex items-center space-x-3 cursor-pointer group/check">
                        ...
                        <div className="flex space-x-4 pt-4">
                          ...
                          >
                            ...
                            <span>
                              {isSaving ? "Saving Book..." : "Save Book"}
                            </span>
                          </button>
                          <button
                            onClick={() => setIsEditing(null)}
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  {events.map((event: any) => (
                    <div
                      key={event.id}
                      className="p-8 bg-brand-beige/30 rounded-[40px] border border-gray-100 flex flex-col md:flex-row gap-10 group"
                    >
                      <div className="flex-grow space-y-4">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="px-4 py-1 bg-brand-primary text-white text-[10px] font-bold rounded-full uppercase tracking-widest">
                            {event.year}
                          </span>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2 pt-4">
                          {event.gallery?.map((img: string, i: number) =>
                            img ? (
                              <div
                                key={i}
                                className="w-16 h-16 rounded-xl overflow-hidden bg-white border border-gray-100"
                              >
                                <img
                                  src={img}
                                  alt="gallery"
            ...
            {activeTab === "partners" && (
              <div className="space-y-8">
                <div className="flex justify-between items-center mb-10">
                  ...
                  <button
                    onClick={() => {
                      setIsEditing("new-partner");
                      setFormData({ order: partners.length });
                    }}
                    className="flex items-center space-x-2 px-6 py-3 bg-brand-primary text-white rounded-full text-xs font-bold uppercase tracking-widest hover:scale-105 transition-transform"
                  >
                    <Plus size={14} />
                ...
                <AnimatePresence>
                  {(isEditing === "new-partner" ||
                    partners.some((p) => p.id === isEditing)) && (
                    <motion.div
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      exit={{ opacity: 0 }}
            ...
            {activeTab === "whyRichkiss" && (
              <div className="space-y-8">
                <div className="flex justify-between items-center mb-10">
                  <h2 className="text-3xl font-serif text-brand-secondary">
                    Why Richkiss? (Careers)
                  </h2>
                  <button
                    onClick={() => {
                      setIsEditing("new-why");
                      setFormData({ order: whyRichkiss.length });
                    }}
                    className="flex items-center space-x-2 px-6 py-3 bg-brand-primary text-white rounded-full text-xs font-bold uppercase tracking-widest hover:scale-105 transition-transform"
                  >
                    <Plus size={14} />
                    ...
                    >
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-xs text-brand-muted line-clamp-1 max-w-xs">
                            {item.description}
                          </p>
                        </div>
                      </div>
                      <div className="flex space-x-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <button
                          onClick={() => handleDelete("whyRichkiss", item.id)}
                          className="p-2 bg-white rounded-lg text-red-500 hover:bg-red-500 hover:text-white"
                        >
                          <Trash2 size={16} />
                        </button>
                      </div>
                ...
                <AnimatePresence>
                  {(isEditing === "new-why" ||
                    whyRichkiss.some((i) => i.id === isEditing)) && (
                    <motion.div
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      exit={{ opacity: 0 }}
            ...
            {activeTab === "printWorks" && (
              <div className="space-y-8">
                <div className="flex justify-between items-center mb-10">
                  <h2 className="text-3xl font-serif text-brand-secondary">
                    Our Works (Print Dept)
                  </h2>
                  <button
                    onClick={() => {
                      setIsEditing("new-work");
                      setFormData({ order: printWorks.length });
                    }}
                    className="flex items-center space-x-2 px-6 py-3 bg-brand-primary text-white rounded-full text-xs font-bold uppercase tracking-widest hover:scale-105 transition-transform"
                  >
                    <Plus size={14} />
                      ...
                      <div className="relative aspect-[4/5] rounded-2xl overflow-hidden bg-gray-200">
                        ...
                        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center space-x-2">
                          <button
                            ...
                            className="p-3 bg-white rounded-xl text-brand-secondary hover:text-brand-primary"
                          >
                            <Edit2 size={18} />
                          </button>
                          <button
                            onClick={() => handleDelete("printWorks", work.id)}
                            className="p-3 bg-white rounded-xl text-red-500"
                          >
                            <Trash2 size={18} />
                          </button>
                        </div>
                ...
                <AnimatePresence>
                  {(isEditing === "new-work" ||
                    printWorks.some((w) => w.id === isEditing)) && (
                    <motion.div
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      exit={{ opacity: 0 }}
